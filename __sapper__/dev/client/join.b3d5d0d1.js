...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 55, 8, 811);
			attr_dev(input0, "id", "code");
			attr_dev(input0, "type", "text");
			add_location(input0, file, 55, 41, 844);
			add_location(br0, file, 55, 94, 897);
			attr_dev(label1, "for", "name");
			add_location(label1, file, 56, 8, 910);
			attr_dev(input1, "id", "name");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 56, 41, 943);
			add_location(br1, file, 56, 96, 998);
			add_location(button, file, 57, 8, 1011);
			add_location(div, file, 54, 4, 796);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 50, 4, 632);
			add_location(p1, file, 51, 4, 670);
			add_location(button, file, 52, 4, 759);
		},
		m: function mount(target, anchor) {
