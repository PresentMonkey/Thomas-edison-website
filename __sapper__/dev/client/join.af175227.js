import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, u as onMount, w as dataset_dev, x as globals, a as space, e as element, t as text, y as empty$1, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, k as add_location, l as insert_dev, m as append_dev, n as noop, j as attr_dev, z as set_input_value, A as listen_dev, B as run_all } from './client.f1f00631.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 57, 8, 875);
			attr_dev(input0, "id", "code");
			attr_dev(input0, "type", "text");
			add_location(input0, file, 57, 41, 908);
			add_location(br0, file, 57, 94, 961);
			attr_dev(label1, "for", "name");
			add_location(label1, file, 58, 8, 974);
			attr_dev(input1, "id", "name");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 58, 41, 1007);
			add_location(br1, file, 58, 96, 1062);
			add_location(button, file, 59, 8, 1075);
			add_location(div, file, 56, 4, 860);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 52, 4, 696);
			add_location(p1, file, 53, 4, 734);
			add_location(button, file, 54, 4, 823);
		},
		m: function mount(target, anchor) {
