...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 55, 8, 812);
			attr_dev(input0, "id", "code");
			attr_dev(input0, "type", "text");
			add_location(input0, file, 55, 41, 845);
			add_location(br0, file, 55, 94, 898);
			attr_dev(label1, "for", "name");
			add_location(label1, file, 56, 8, 911);
			attr_dev(input1, "id", "name");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 56, 41, 944);
			add_location(br1, file, 56, 96, 999);
			add_location(button, file, 57, 8, 1012);
			add_location(div, file, 54, 4, 797);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 50, 4, 633);
			add_location(p1, file, 51, 4, 671);
			add_location(button, file, 52, 4, 760);
		},
		m: function mount(target, anchor) {
