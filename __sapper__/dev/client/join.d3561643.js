...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 47, 8, 650);
			attr_dev(input0, "id", "code");
			attr_dev(input0, "type", "text");
			add_location(input0, file, 47, 41, 683);
			add_location(br0, file, 47, 94, 736);
			attr_dev(label1, "for", "name");
			add_location(label1, file, 48, 8, 749);
			attr_dev(input1, "id", "name");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 48, 41, 782);
			add_location(br1, file, 48, 96, 837);
			add_location(button, file, 49, 8, 850);
			add_location(div, file, 46, 4, 635);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 42, 4, 471);
			add_location(p1, file, 43, 4, 509);
			add_location(button, file, 44, 4, 598);
		},
		m: function mount(target, anchor) {
