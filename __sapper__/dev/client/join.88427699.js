...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 51, 8, 748);
			attr_dev(input0, "id", "code");
			attr_dev(input0, "type", "text");
			add_location(input0, file, 51, 41, 781);
			add_location(br0, file, 51, 94, 834);
			attr_dev(label1, "for", "name");
			add_location(label1, file, 52, 8, 847);
			attr_dev(input1, "id", "name");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 52, 41, 880);
			add_location(br1, file, 52, 96, 935);
			add_location(button, file, 53, 8, 948);
			add_location(div, file, 50, 4, 733);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 46, 4, 569);
			add_location(p1, file, 47, 4, 607);
			add_location(button, file, 48, 4, 696);
		},
		m: function mount(target, anchor) {
